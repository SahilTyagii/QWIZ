...
function Pattern() {
  return (
    <div className='w-full flex flex-row justify-center fixed bg-white bottom-0 h-1/2 -z-10' style={{backgroundImage: "url(https://www.transparenttextures.com/patterns/arches.png)", backgroundColor:"white"}}>
