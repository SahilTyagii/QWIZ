...
function Room() {
    ...
    const audio = useRef(new Audio(Countdown));
    const threeSecAudio = useRef(new Audio(three));
    ...
    const cleanupAudio = () => {
        ...
        if (threeSecAudio.current) {
            threeSecAudio.current.pause();
            threeSecAudio.current.currentTime = 0;
        }
    };
        ...
        <div>
            {
                gameStarted ? (
                    <div>
                        {showQuestion ? (
                            <MpQuestion questions={questions} correctAns={correctAns} playerState={playerState} user={user} countdownStop={countdownStop} />
                        ) : (
